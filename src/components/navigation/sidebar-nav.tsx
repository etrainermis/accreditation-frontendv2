    ...
    <div className="flex h-full flex-col">
          ...
          return (
            <Link
              ...
              className={cn(
                ...
                item.isActive
                  ? "bg-[#EFF6FF] text-[#0088ff]"
                  : "text-[#344054] hover:bg-[#EFF6FF] hover:text-[#0088ff]",
              )}
      ...
      <div className="mb-1 flex flex-col gap-0.5">
        <button
          type="button"
          onClick={() => onCloseMobile?.()}
          className="group flex w-full items-center gap-3 rounded-lg px-3 py-2.5 text-[#344054] transition-colors duration-150 hover:bg-[#EFF6FF] hover:text-[#0088ff]"
        >
          <HelpCircle
