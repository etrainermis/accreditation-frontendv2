              ...
              <div className="absolute inset-[8.33%_12.5%_29.17%_37.5%]" data-name="Vector">
                <div className="absolute inset-[-3.33%_-4.17%]">
                  <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 13 16">
                    <path d={svgPaths.p3a02a500} id="Vector" stroke="var(--stroke-0, #353E49)" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </div>
              </div>
              <div className="absolute inset-[8.33%_12.5%_66.67%_62.5%]" data-name="Vector">
                <div className="absolute inset-[-8.33%]">
                  <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 7.00001 7.00001">
                    <path d={svgPaths.p1edeb400} id="Vector" stroke="var(--stroke-0, #353E49)" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </div>
              </div>
              <div className="absolute inset-[29.17%_38.62%_8.33%_12.5%]" data-name="Vector">
                <div className="absolute inset-[-3.33%_-4.26%]">
                  <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12.7321 16">
                    <path d={svgPaths.p2ad86d80} id="Vector" stroke="var(--stroke-0, #353E49)" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </div>
              </div>
            </div>
    ...
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Column">
      ...
      <div className="content-stretch flex gap-[12px] h-[72px] items-center justify-end px-[24px] py-[16px] relative shrink-0" data-name="Table cell">
        ...
        <div className="content-stretch flex gap-[6px] items-center justify-center overflow-clip relative shrink-0" data-name="Buttons/Button">
          <p className="font-['Nunito_Sans:Medium',sans-serif] font-medium leading-[20px] relative shrink-0 text-[#475467] text-[14px] whitespace-nowrap" style={{ fontVariationSettings: "'YTLC' 500, 'wdth' 100" }}>
            Download
          </p>
        </div>
        <div className="content-stretch flex gap-[6px] items-center justify-center overflow-clip relative shrink-0" data-name="Buttons/Button">
      ...
      <div className="content-stretch flex flex-col items-start overflow-clip relative rounded-[inherit] w-full">
        <div className="bg-white content-stretch flex flex-col gap-[20px] isolate items-start relative shrink-0 w-full" data-name="Card header">
          ...
          <div className="h-px relative shrink-0 w-full z-[1]" data-name="Divider">
            <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 480 1">
              <path clipRule="evenodd" d="M480 1H0V0H480V1Z" fill="var(--fill-0, #EAECF0)" fillRule="evenodd" id="Divider" />
            </svg>
          </div>
        </div>
        <Content16 />
...
export default function CurriculumDoc() {
  return (
    <div className="bg-white relative size-full" data-name="CURRICULUM_DOC">
      <Frame6 />
      <SidebarNavigation />
    </div>
  );
