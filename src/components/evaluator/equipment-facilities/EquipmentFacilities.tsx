              ...
              <div className="absolute inset-[12.51%_35.99%_54.16%_12.51%]" data-name="Vector">
                <div className="absolute inset-[-6.25%_-4.04%]">
                  <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 13.3619 9.00051">
                    <path d={svgPaths.p25909550} id="Vector" stroke="var(--stroke-0, #353E49)" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </div>
              </div>
              <div className="absolute inset-[11.8%_11.83%_54.19%_61.45%]" data-name="Vector">
                <div className="absolute inset-[-6.12%_-7.8%_-6.13%_-7.8%]">
                  <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 7.41106 9.16366">
                    <path d={svgPaths.p2f7da900} id="Vector" stroke="var(--stroke-0, #353E49)" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </div>
              </div>
              <div className="absolute inset-[45.83%_16.67%_12.5%_16.67%]" data-name="Vector">
                <div className="absolute inset-[-5%_-3.12%]">
                  <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 17 11">
                    <path d={svgPaths.p1bdd09f0} id="Vector" stroke="var(--stroke-0, #353E49)" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </div>
              </div>
            </div>
...
function TextAndSupportingText6() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 text-center w-full" data-name="Text and supporting text">
      <p className="font-['Nunito_Sans:Medium',sans-serif] font-medium leading-[28px] relative shrink-0 text-[#101828] text-[18px] w-full" style={{ fontVariationSettings: "'YTLC' 500, 'wdth' 100" }}>{`Equipment & Facilities`}</p>
  ...
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-center relative shrink-0 w-full" data-name="Header">
      <div className="bg-white relative rounded-[12px] shrink-0 size-[56px]" data-name="Featured icon">
        ...
        <div className="absolute left-[14px] overflow-clip size-[28px] top-[14px]" data-name="tool-case">
          <div className="absolute inset-[62.5%_41.67%_37.5%_41.67%]" data-name="Vector">
            <div className="absolute inset-[-0.5px_-10.71%]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 5.66667 1">
                <path d="M0.5 0.5H5.16667" id="Vector" stroke="var(--stroke-0, #353E49)" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </div>
          </div>
          <div className="absolute inset-[12.51%_35.99%_54.16%_12.51%]" data-name="Vector">
            <div className="absolute inset-[-5.36%_-3.47%]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15.4222 10.3339">
                <path d={svgPaths.p13a12340} id="Vector" stroke="var(--stroke-0, #353E49)" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </div>
          </div>
          <div className="absolute inset-[11.8%_11.83%_54.19%_61.45%]" data-name="Vector">
            <div className="absolute inset-[-5.25%_-6.69%]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 8.47954 10.5242">
                <path d={svgPaths.p37894080} id="Vector" stroke="var(--stroke-0, #353E49)" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </div>
          </div>
          <div className="absolute inset-[45.83%_16.67%_12.5%_16.67%]" data-name="Vector">
            <div className="absolute inset-[-4.29%_-2.68%]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 19.6667 12.6667">
                <path d={svgPaths.p2ce3d400} id="Vector" stroke="var(--stroke-0, #353E49)" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </div>
          </div>
        </div>
...
function TextAndSupportingText7() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start leading-[18px] relative shrink-0 w-full" data-name="Text and supporting text">
...
export default function EquipmentFacilities() {
  return (
    <div className="bg-white relative size-full" data-name="EQUIPMENT & FACILITIES">
      <Frame6 />
      <SidebarNavigation />
    </div>
  );
