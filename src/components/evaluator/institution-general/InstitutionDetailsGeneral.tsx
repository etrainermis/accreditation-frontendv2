...
function Content17() {
  return (
    <div className="content-stretch flex gap-[12px] items-center relative shrink-0" data-name="Content">
      <p className="font-['Nunito_Sans:Medium',sans-serif] font-medium leading-[20px] relative shrink-0 text-[#353e49] text-[14px] whitespace-nowrap" style={{ fontVariationSettings: "'YTLC' 500, 'wdth' 100" }}>{`Personnel `}</p>
    </div>
  );
}
...
function Content19() {
  return (
    <div className="content-stretch flex flex-[1_0_0] h-full items-center min-h-px min-w-px relative" data-name="Content">
      <p className="flex-[1_0_0] font-['Nunito_Sans:Regular',sans-serif] font-light leading-[18px] min-h-px min-w-px overflow-hidden relative text-[#101828] text-[12px] text-ellipsis text-left whitespace-nowrap" style={{ fontVariationSettings: "'YTLC' 500, 'wdth' 100" }}>
        e.g. Sina Gerard Rwanda
      </p>
    </div>
  );
}
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[8px] items-center px-[14px] py-[10px] relative size-full">
          ...
          <div className="relative shrink-0 size-[16px]" data-name="Help icon">
            <div className="absolute inset-0 overflow-clip" data-name="building-2">
              <div className="absolute bottom-1/2 left-[41.67%] right-[41.67%] top-1/2" data-name="Vector">
                <div className="absolute inset-[-0.5px_-18.75%]">
                  <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 3.66667 1">
                    <path d="M0.5 0.5H3.16667" id="Vector" stroke="var(--stroke-0, #AAAFB5)" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </div>
              </div>
              <div className="absolute inset-[33.33%_41.67%_66.67%_41.67%]" data-name="Vector">
              ...
              <div className="absolute inset-[66.67%_41.67%_12.5%_41.67%]" data-name="Vector">
                <div className="absolute inset-[-15%_-18.75%]">
                  <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 3.66667 4.33333">
                    <path d={svgPaths.p1cb7c980} id="Vector" stroke="var(--stroke-0, #AAAFB5)" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </div>
              </div>
              <div className="absolute inset-[29.17%_8.33%_12.5%_8.33%]" data-name="Vector">
                <div className="absolute inset-[-5.36%_-3.75%]">
                  <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14.3333 10.3333">
                    <path d={svgPaths.p3ec4b3c0} id="Vector" stroke="var(--stroke-0, #AAAFB5)" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </div>
              </div>
              <div className="absolute bottom-[12.5%] left-1/4 right-1/4 top-[12.5%]" data-name="Vector">
                <div className="absolute inset-[-4.17%_-6.25%]">
                  <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 9 13">
                    <path d={svgPaths.p23ccf380} id="Vector" stroke="var(--stroke-0, #AAAFB5)" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </div>
              </div>
            </div>
...
function InputWithLabel() {
  return (
    <div className="content-stretch flex flex-col gap-[6px] h-[70px] items-start relative shrink-0 w-full" data-name="Input with label">
      <p className="font-['Nunito_Sans:Regular',sans-serif] font-normal leading-[20px] relative shrink-0 text-[#344054] text-[14px] text-left whitespace-nowrap" style={{ fontVariationSettings: "'YTLC' 500, 'wdth' 100" }}>{`Name of Institution `}</p>
      <Input />
    </div>
  );
}
...
function TextInput() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[8px] items-start min-h-px min-w-px relative" data-name="Text input">
      <p className="flex-[1_0_0] font-['Nunito_Sans:Regular',sans-serif] font-light leading-[18px] min-h-px min-w-px overflow-hidden relative text-[#101828] text-[12px] text-ellipsis text-left whitespace-nowrap" style={{ fontVariationSettings: "'YTLC' 500, 'wdth' 100" }}>
        Select type
      </p>
    </div>
...
function Content20() {
  return (
    <div className="flex-[1_0_0] h-full min-h-px min-w-px relative" data-name="Content">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[8px] items-center pl-[14px] py-[10px] relative size-full">
          <TextInput />
        </div>
      </div>
    </div>
...
function Dropdown1() {
  return (
    <div className="h-full relative shrink-0" data-name="Dropdown">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex gap-[4px] h-full items-center px-[14px] py-[10px] relative">
            ...
            <div className="absolute bottom-[37.5%] left-1/4 right-1/4 top-[37.5%]" data-name="Vector">
              <div className="absolute inset-[-10%_-5%]">
                <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 11 6">
                  <path d="M0.5 0.5L5.5 5.5L10.5 0.5" id="Vector" stroke="var(--stroke-0, #AAAFB5)" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </div>
            </div>
          </div>
...
function Input1() {
  return (
    <div className="bg-white content-stretch flex flex-[1_0_0] items-start min-h-px min-w-px relative rounded-[8px] w-full" data-name="Input">
      <div aria-hidden="true" className="absolute border border-[#d0d5dd] border-solid inset-0 pointer-events-none rounded-[8px] shadow-[0px_1px_2px_0px_rgba(16,24,40,0.05)]" />
      <Content20 />
      <Dropdown1 />
    </div>
...
function InputWithLabel1() {
  return (
    <div className="content-stretch flex flex-col gap-[6px] h-[70px] items-start relative shrink-0 w-full" data-name="Input with label">
      <p className="font-['Nunito_Sans:Regular',sans-serif] font-normal leading-[20px] relative shrink-0 text-[#344054] text-[14px] text-left whitespace-nowrap" style={{ fontVariationSettings: "'YTLC' 500, 'wdth' 100" }}>{`Institution Type `}</p>
      <Input1 />
    </div>
  );
}
    ...
    <div className="bg-white flex-[1_0_0] min-h-px min-w-px relative rounded-[8px] w-full" data-name="Input">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[8px] items-center px-[14px] py-[10px] relative size-full">
          <Content21 />
          <div className="relative shrink-0 size-[16px]" data-name="Help icon">
            <div className="absolute inset-0 overflow-clip" data-name="package">
              <div className="absolute inset-[8.34%_12.5%]" data-name="Vector">
                <div className="absolute inset-[-3.75%_-4.17%]">
                  <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 13 14.3306">
                    <path d={svgPaths.p63db6c0} id="Vector" stroke="var(--stroke-0, #AAAFB5)" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </div>
              </div>
              <div className="absolute bottom-[8.33%] left-1/2 right-1/2 top-1/2" data-name="Vector">
                <div className="absolute inset-[-7.5%_-0.5px]">
                  <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1 7.66667">
                    <path d="M0.5 7.16667V0.5" id="Vector" stroke="var(--stroke-0, #AAAFB5)" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </div>
              </div>
              <div className="absolute bottom-1/2 left-[13.71%] right-[13.71%] top-[29.17%]" data-name="Vector">
                <div className="absolute inset-[-15%_-4.31%]">
                  <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12.6135 4.33342">
                    <path d={svgPaths.p32600900} id="Vector" stroke="var(--stroke-0, #AAAFB5)" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </div>
              </div>
              <div className="absolute inset-[17.79%_31.25%_60.75%_31.25%]" data-name="Vector">
                <div className="absolute inset-[-14.57%_-8.33%]">
                  <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 7.00017 4.4335">
                    <path d={svgPaths.p3d2efe80} id="Vector" stroke="var(--stroke-0, #AAAFB5)" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </div>
              </div>
            </div>
...
function FieldSetHorizontal() {
  return (
    <div className="content-stretch flex gap-[20px] items-start relative shrink-0 w-full" data-name="Field Set Horizontal">
      <button className="content-stretch flex flex-[1_0_0] flex-col gap-[6px] h-[70px] items-start min-h-px min-w-px relative" data-name="Input field">
        <InputWithLabel1 />
      </button>
    ...
    <div className="bg-white flex-[1_0_0] min-h-px min-w-px relative rounded-[8px] w-full" data-name="Input">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[8px] items-center px-[14px] py-[10px] relative size-full">
          <Content22 />
          <div className="relative shrink-0 size-[16px]" data-name="Help icon">
            <div className="absolute inset-0 overflow-clip" data-name="mail">
              <div className="absolute inset-[29.17%_8.33%_45.84%_8.33%]" data-name="Vector">
                <div className="absolute inset-[-12.51%_-3.75%]">
                  <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14.3335 4.99843">
                    <path d={svgPaths.p3bb215c0} id="Vector" stroke="var(--stroke-0, #AAAFB5)" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </div>
              </div>
              <div className="absolute inset-[16.67%_8.33%]" data-name="Vector">
                <div className="absolute inset-[-4.69%_-3.75%]">
                  <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14.3333 11.6667">
                    <path d={svgPaths.p1e4387f0} id="Vector" stroke="var(--stroke-0, #AAAFB5)" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </div>
              </div>
            </div>
...
function Dropdown2() {
  return (
    <div className="h-full relative shrink-0" data-name="Dropdown">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex gap-[4px] h-full items-center pl-[14px] py-[10px] relative">
          <p className="font-['Nunito_Sans:Regular',sans-serif] font-normal leading-[20px] relative shrink-0 text-[#344054] text-[14px] text-left whitespace-nowrap" style={{ fontVariationSettings: "'YTLC' 500, 'wdth' 100" }}>
            +250
          </p>
          <div className="overflow-clip relative shrink-0 size-[20px]" data-name="chevron-down">
...
function TextInput1() {
  return (
    <div className="flex-[1_0_0] h-full min-h-px min-w-px relative" data-name="Text input">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[8px] items-center pl-[12px] pr-[14px] py-[10px] relative size-full">
          <p className="flex-[1_0_0] font-['Nunito_Sans:Regular',sans-serif] font-light leading-[18px] min-h-px min-w-px overflow-hidden relative text-[#101828] text-[12px] text-ellipsis text-left whitespace-nowrap" style={{ fontVariationSettings: "'YTLC' 500, 'wdth' 100" }}>
            791-234-567
          </p>
          <div className="relative shrink-0 size-[16px]" data-name="Help icon">
              ...
              <div className="absolute inset-[8.33%]" data-name="Vector">
                <div className="absolute inset-[-3.75%]">
                  <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14.3333 14.3333">
                    <path d={svgPaths.p1b94c680} id="Vector" stroke="var(--stroke-0, #AAAFB5)" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </div>
              </div>
            </div>
...
function Form() {
  return (
    <div className="content-stretch cursor-pointer flex flex-col gap-[20px] items-start relative shrink-0 w-full" data-name="Form">
      <button className="content-stretch flex flex-col gap-[6px] items-start relative shrink-0 w-full" data-name="Input field">
        <InputWithLabel />
      </button>
      <FieldSetHorizontal />
      <button className="content-stretch flex flex-col gap-[6px] items-start relative shrink-0 w-full" data-name="Input field">
...
export default function InstitutionDetailsGeneral() {
  return (
    <div className="bg-white relative size-full" data-name="INSTITUTION_DETAILS [GENERAL]">
      <Frame6 />
