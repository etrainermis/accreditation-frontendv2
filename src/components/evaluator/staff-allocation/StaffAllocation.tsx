              ...
              <div className="absolute inset-[16.67%_45.83%_58.33%_20.83%]" data-name="Vector">
                <div className="absolute inset-[-8.33%_-6.25%]">
                  <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 9 7">
                    <path d={svgPaths.p3c77fa00} id="Vector" stroke="var(--stroke-0, #34C759)" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </div>
              </div>
              ...
              <div className="absolute inset-[12.51%_35.99%_54.16%_12.51%]" data-name="Vector">
                <div className="absolute inset-[-6.25%_-4.04%]">
                  <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 13.3619 9.00051">
                    <path d={svgPaths.p25909550} id="Vector" stroke="var(--stroke-0, #34C759)" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </div>
              </div>
              <div className="absolute inset-[11.8%_11.83%_54.19%_61.45%]" data-name="Vector">
                <div className="absolute inset-[-6.12%_-7.8%_-6.13%_-7.8%]">
                  <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 7.41106 9.16366">
                    <path d={svgPaths.p2f7da900} id="Vector" stroke="var(--stroke-0, #34C759)" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </div>
              </div>
              <div className="absolute inset-[45.83%_16.67%_12.5%_16.67%]" data-name="Vector">
                <div className="absolute inset-[-5%_-3.12%]">
                  <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 17 11">
                    <path d={svgPaths.p1bdd09f0} id="Vector" stroke="var(--stroke-0, #34C759)" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </div>
              </div>
            </div>
...
function ConnectorWrap3() {
  return (
    <div className="relative self-stretch shrink-0" data-name="Connector wrap">
      <div className="flex flex-col items-center size-full">
        <div className="content-stretch flex flex-col gap-[4px] h-full items-center pb-[4px] relative">
          <div className="relative rounded-[10px] shrink-0 size-[48px]" data-name="Featured icon">
            <div aria-hidden="true" className="absolute border border-[#eaecf0] border-solid inset-0 pointer-events-none rounded-[10px] shadow-[0px_1px_2px_0px_rgba(16,24,40,0.05)]" />
              ...
              <div className="absolute inset-[8.33%_12.5%_29.17%_37.5%]" data-name="Vector">
                <div className="absolute inset-[-3.33%_-4.17%]">
                  <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 13 16">
                    <path d={svgPaths.p3a02a500} id="Vector" stroke="var(--stroke-0, #34C759)" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </div>
              </div>
              <div className="absolute inset-[8.33%_12.5%_66.67%_62.5%]" data-name="Vector">
                <div className="absolute inset-[-8.33%]">
                  <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 7.00001 7.00001">
                    <path d={svgPaths.p1edeb400} id="Vector" stroke="var(--stroke-0, #34C759)" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </div>
              </div>
              <div className="absolute inset-[29.17%_38.62%_8.33%_12.5%]" data-name="Vector">
                <div className="absolute inset-[-3.33%_-4.26%]">
                  <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12.7321 16">
                    <path d={svgPaths.p2ad86d80} id="Vector" stroke="var(--stroke-0, #34C759)" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </div>
              </div>
            </div>
              ...
              <div className="absolute inset-[62.5%_33.33%_12.5%_8.33%]" data-name="Vector">
                <div className="absolute inset-[-8.33%_-3.57%]">
                  <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15 7">
                    <path d={svgPaths.p2349cb97} id="Vector" stroke="var(--stroke-0, #353E49)" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </div>
              </div>
              <div className="absolute inset-[13.03%_20.85%_54.7%_66.67%]" data-name="Vector">
                <div className="absolute inset-[-6.46%_-16.69%]">
                  <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 3.99632 8.74424">
                    <path d={svgPaths.p32a1c800} id="Vector" stroke="var(--stroke-0, #353E49)" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </div>
              </div>
              <div className="absolute inset-[63.04%_8.33%_12.5%_79.17%]" data-name="Vector">
                <div className="absolute inset-[-8.52%_-16.67%]">
                  <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 4.00012 6.87012">
                    <path d={svgPaths.p32fac0c0} id="Vector" stroke="var(--stroke-0, #353E49)" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </div>
              </div>
              <div className="absolute inset-[12.5%_45.83%_54.17%_20.83%]" data-name="Vector">
                <div className="absolute inset-[-6.25%]">
                  <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 9 9">
                    <path d={svgPaths.p2a600700} id="Vector" stroke="var(--stroke-0, #353E49)" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </div>
              </div>
            </div>
...
function ProgressStepsProgressIconsWithText() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-h-px min-w-px relative w-full" data-name="Progress steps / Progress icons with text">
      ...
      <div className="content-stretch flex gap-[16px] items-start opacity-60 relative shrink-0 w-full" data-name="_Step base">
        <ConnectorWrap3 />
...
function TextAndSupportingText6() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 text-center w-full" data-name="Text and supporting text">
      <p className="font-['Nunito_Sans:Medium',sans-serif] font-medium leading-[28px] relative shrink-0 text-[#101828] text-[18px] w-full" style={{ fontVariationSettings: "'YTLC' 500, 'wdth' 100" }}>
        Staff Allocation
      </p>
      <p className="font-['Nunito_Sans:Regular',sans-serif] font-normal leading-[0] relative shrink-0 text-[#353e49] text-[14px] w-full" style={{ fontVariationSettings: "'YTLC' 500, 'wdth' 100" }}>
        <span className="leading-[20px]">{` `}</span>
        <span className="leading-[20px]">Upload curriculum and training materials</span>
        <span className="leading-[20px]">.</span>
      </p>
    </div>
  );
  ...
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-center relative shrink-0 w-full" data-name="Header">
      <div className="bg-white relative rounded-[12px] shrink-0 size-[56px]" data-name="Featured icon">
        ...
        <div className="absolute left-[14px] overflow-clip size-[28px] top-[14px]" data-name="files">
          <div className="absolute inset-[8.33%_12.5%_29.17%_37.5%]" data-name="Vector">
            <div className="absolute inset-[-2.86%_-3.57%]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15 18.5">
                <path d={svgPaths.p1cc8c6c0} id="Vector" stroke="var(--stroke-0, #353E49)" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </div>
          </div>
          <div className="absolute inset-[8.33%_12.5%_66.67%_62.5%]" data-name="Vector">
            <div className="absolute inset-[-7.14%]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 8.00001 8.00001">
                <path d={svgPaths.p32c56940} id="Vector" stroke="var(--stroke-0, #353E49)" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </div>
          </div>
          <div className="absolute inset-[29.17%_38.62%_8.33%_12.5%]" data-name="Vector">
            <div className="absolute inset-[-2.86%_-3.65%]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14.6874 18.5">
                <path d={svgPaths.pc8b3400} id="Vector" stroke="var(--stroke-0, #353E49)" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </div>
          </div>
        </div>
...
function TextAndSupportingText7() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-h-px min-w-px relative" data-name="Text and supporting text">
      <p className="font-['Nunito_Sans:Medium',sans-serif] font-medium leading-[20px] overflow-hidden relative shrink-0 text-[#101828] text-[14px] text-ellipsis w-full whitespace-nowrap" style={{ fontVariationSettings: "'YTLC' 500, 'wdth' 100" }}>
        Position
      </p>
      <p className="font-['Nunito_Sans:Regular',sans-serif] font-light leading-[18px] relative shrink-0 text-[#475467] text-[12px] w-full" style={{ fontVariationSettings: "'YTLC' 500, 'wdth' 100" }}>
        Qualification
...
function Column() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-h-px min-w-px relative" data-name="Column">
      <div className="h-[52px] relative shrink-0 w-full" data-name="Table header cell">
        ...
        <div className="flex flex-row items-center size-full">
          <div className="content-stretch flex gap-[12px] items-center px-[24px] py-[12px] relative size-full">
            ...
            <div className="content-stretch flex items-center relative shrink-0" data-name="Table header">
              <p className="font-['Nunito_Sans:Medium',sans-serif] font-medium leading-[18px] relative shrink-0 text-[#475467] text-[12px] whitespace-nowrap" style={{ fontVariationSettings: "'YTLC' 500, 'wdth' 100" }}>{`Position & Qualification`}</p>
            </div>
          </div>
        </div>
      </div>
      <div className="h-[72px] relative shrink-0 w-full" data-name="Table cell">
        ...
        <div className="flex flex-row items-center size-full">
          <div className="content-stretch flex gap-[12px] items-center px-[24px] py-[16px] relative size-full">
            ...
            <div className="relative rounded-[9999px] shrink-0 size-[40px]" data-name="Avatar">
              <div className="absolute inset-[20%] overflow-clip" data-name="user">
...
function Column1() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[138px]" data-name="Column">
      ...
      <div className="h-[72px] relative shrink-0 w-full" data-name="Table cell">
        ...
        <div className="flex flex-row items-center size-full">
          <div className="content-stretch flex items-center px-[24px] py-[16px] relative size-full">
            <p className="flex-[1_0_0] font-['Nunito_Sans:Regular',sans-serif] font-light leading-[18px] min-h-px min-w-px overflow-hidden relative text-[#101828] text-[12px] text-ellipsis whitespace-nowrap" style={{ fontVariationSettings: "'YTLC' 500, 'wdth' 100" }}>
              2
            </p>
          </div>
        </div>
  ...
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[48px]" data-name="Column">
      ...
      <div className="h-[72px] relative shrink-0 w-full" data-name="Table cell">
        ...
        <div className="flex flex-row items-center size-full">
          <div className="content-stretch flex items-center px-[24px] py-[16px] relative size-full">
            <div className="content-stretch flex gap-[4px] items-center pl-[6px] pr-[4px] py-[2px] relative rounded-[6px] shrink-0" data-name="Badge">
...
function Table() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px min-w-px relative rounded-[12px]" data-name="Table">
...
function Content16() {
  return (
    <div className="content-start flex flex-wrap gap-y-[16px] items-start relative shrink-0 w-full" data-name="Content">
      <Table />
    </div>
  );
}
...
export default function StaffAllocation() {
  return (
    <div className="bg-white relative size-full" data-name="STAFF_ALLOCATION">
      <Frame6 />
      <SidebarNavigation />
    </div>
  );
