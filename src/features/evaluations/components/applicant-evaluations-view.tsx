      ...
      <div className="flex w-full gap-4 mb-8">
        {tabs.map((tab) => {
          ...
          return (
            ...
            >
              <tab.icon className={cn("h-5 w-5", isActive ? "text-[#0A77FF]" : "text-slate-400")} />
              {tab.label}
            </button>
          );
        })}
            ...
            <table className="w-full">
              <thead>
                <tr className="bg-slate-50/50 border-b border-slate-100">
                  <th className="px-8 py-5 text-[12px] font-bold text-slate-400 uppercase tracking-wider text-left">Application</th>
                  <th className="px-8 py-5 text-[12px] font-bold text-slate-400 uppercase tracking-wider text-left">Certificate</th>
                  <th className="px-8 py-5 text-[12px] font-bold text-slate-400 uppercase tracking-wider text-left">Expiration Date</th>
                  <th className="px-8 py-5 text-[12px] font-bold text-slate-400 uppercase tracking-wider text-right">Actions</th>
                </tr>
              </thead>
                    ...
                    <td className="px-8 py-5">
                      <div className="flex items-center gap-3">
                        <div className="h-9 w-9 bg-blue-50 rounded-lg flex items-center justify-center">
                          <FileText className="h-4 w-4 text-[#0A77FF]" />
                        </div>
                        <span className="text-[14px] font-bold text-slate-800">{cert.application}</span>
                      </div>
                    </td>
                    <td className="px-8 py-5">
                      <span className="text-[13px] font-medium text-slate-600">{cert.certificate}</span>
                    </td>
                    <td className="px-8 py-5">
                      <div className="flex items-center gap-2">
                        <Clock className="h-3.5 w-3.5 text-slate-400" />
                        <span className="text-[13px] font-medium text-slate-600">{cert.expiryDate}</span>
                      </div>
                    </td>
                    <td className="px-8 py-5 text-right">
                       <button className="text-[13px] font-bold text-[#0A77FF] hover:underline">Download</button>
                    </td>
                  </tr>
                ))}
              </tbody>
