...
import { CalendarDays, Clock, CheckCheck, AlertCircle, XCircle } from "lucide-react";
...
const stats = [
  { label: "Total scheduled visits", value: "24", icon: CalendarDays, iconColor: "#0A77FF" },
  { label: "Today's visit", value: "3", icon: Clock, iconColor: "#FF8D28" },
