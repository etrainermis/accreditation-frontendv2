...
import { Mail, Eye, EyeOff, Info, EyeClosed } from "lucide-react";
  ...
  return (
    <main className="grid min-h-screen lg:grid-cols-[1fr_480px]">
      ...
      <DotPatternBackground>
        ...
        <p className="absolute sm:bottom-10 md:bottom-15 lg:bottom-20 left-6 text-xs text-slate-400 lg:left-10">© RTB {getCurrentYear()}</p>
      </DotPatternBackground>
