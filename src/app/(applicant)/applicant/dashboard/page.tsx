...
export default function ApplicantDashboardPage() {
  ...
  return (
    <PageContainer 
      role="applicant" 
      title="Welcome, John" 
      description="View & manage active orders and requests"
      action={<PrimaryButton label="New Application" href="/applicant/applications" iconPosition="right" />}
    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.1fr_1fr] gap-6 pt-4 items-start pb-8">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex flex-col gap-3">
              {/* Card 1 (Active) */}
              <div className="rounded-xl border border-[#0088ff] bg-white p-4 shadow-[0_2px_8px_rgba(0,136,255,0.08)] relative overflow-hidden">
                <div className="flex flex-col sm:flex-row justify-between sm:items-start gap-4 sm:gap-0">
                  <div className="pr-4 w-full">
                    ...
                    <div className="flex flex-wrap items-center gap-2">
                      <span className="text-[10px] font-medium text-[#0088ff]">Software Engineering & Embedded S...</span>
                      <ChevronRight className="h-3 w-3 text-slate-300" strokeWidth={2} />
                      <span className="text-[10px] font-medium text-[#0088ff]">JavaScript</span>
                    </div>
                  </div>
          ...
          <div className="flex flex-col">
            <div className="flex justify-between items-start mb-4">
              ...
              <button className="text-[12px] font-semibold text-[#0088ff] flex items-center gap-1 hover:text-blue-700 transition-colors shrink-0 pt-0.5">
