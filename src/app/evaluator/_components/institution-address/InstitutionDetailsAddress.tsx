...
function InputWithLabel5() {
  return (
    <div className="content-stretch flex flex-col gap-[6px] h-[70px] items-start relative shrink-0 w-full" data-name="Input with label">
      <p className="font-['Nunito_Sans:Regular',sans-serif] font-normal leading-[20px] relative shrink-0 text-[#344054] text-[14px] text-left whitespace-nowrap" style={{ fontVariationSettings: "'YTLC' 500, 'wdth' 100" }}>{`City `}</p>
      <Input5 />
    </div>
  );
}

function FieldSetHorizontal2() {
  return (
    <div className="content-stretch flex gap-[20px] items-start relative shrink-0 w-full" data-name="Field Set Horizontal">
      <button className="content-stretch flex flex-[1_0_0] flex-col gap-[6px] h-[70px] items-start min-h-px min-w-px relative" data-name="Input field">
        <InputWithLabel4 />
...
function InputWithLabel6() {
  return (
    <div className="content-stretch flex flex-col gap-[6px] h-[70px] items-start relative shrink-0 w-full" data-name="Input with label">
      <p className="font-['Nunito_Sans:Regular',sans-serif] font-normal leading-[20px] relative shrink-0 text-[#344054] text-[14px] text-left whitespace-nowrap" style={{ fontVariationSettings: "'YTLC' 500, 'wdth' 100" }}>{`Address Line `}</p>
      <Input6 />
    </div>
  );
}
...
export default function InstitutionDetailsAddress() {
  return (
    <div className="bg-white relative size-full" data-name="INSTITUTION_DETAILS [ADDRESS]">
      <Frame6 />
      <SidebarNavigation />
    </div>
  );
