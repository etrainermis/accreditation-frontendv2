              ...
              <div className="absolute bottom-1/2 left-[41.67%] right-[41.67%] top-1/2" data-name="Vector">
                <div className="absolute inset-[-0.5px_-12.5%]">
                  <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 5 1">
                    <path d="M0.5 0.5H4.5" id="Vector" stroke="var(--stroke-0, #34C759)" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </div>
              </div>
              ...
              <div className="absolute inset-[66.67%_41.67%_12.5%_41.67%]" data-name="Vector">
                <div className="absolute inset-[-10%_-12.5%]">
                  <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 5 6">
                    <path d={svgPaths.p2f97c400} id="Vector" stroke="var(--stroke-0, #34C759)" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </div>
              </div>
              <div className="absolute inset-[29.17%_8.33%_12.5%_8.33%]" data-name="Vector">
                <div className="absolute inset-[-3.57%_-2.5%]">
                  <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 21 15">
                    <path d={svgPaths.p191c64a0} id="Vector" stroke="var(--stroke-0, #34C759)" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </div>
              </div>
              <div className="absolute bottom-[12.5%] left-1/4 right-1/4 top-[12.5%]" data-name="Vector">
                <div className="absolute inset-[-2.78%_-4.17%]">
                  <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 13 19">
                    <path d={svgPaths.p1bfba100} id="Vector" stroke="var(--stroke-0, #34C759)" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </div>
              </div>
            </div>
              ...
              <div className="absolute inset-[16.67%_45.83%_58.33%_20.83%]" data-name="Vector">
                <div className="absolute inset-[-8.33%_-6.25%]">
                  <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 9 7">
                    <path d={svgPaths.p3c77fa00} id="Vector" stroke="var(--stroke-0, #353E49)" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </div>
              </div>
...
function TextAndSupportingText6() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 text-center w-full" data-name="Text and supporting text">
      <p className="font-['Nunito_Sans:Medium',sans-serif] font-medium leading-[28px] relative shrink-0 text-[#101828] text-[18px] w-full" style={{ fontVariationSettings: "'YTLC' 500, 'wdth' 100" }}>{`Trade & Module Selected`}</p>
      <p className="font-['Nunito_Sans:Regular',sans-serif] font-normal leading-[20px] relative shrink-0 text-[#475467] text-[14px] w-full" style={{ fontVariationSettings: "'YTLC' 500, 'wdth' 100" }}>
  ...
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-center relative shrink-0 w-full" data-name="Header">
      <div className="bg-white relative rounded-[12px] shrink-0 size-[56px]" data-name="Featured icon">
        ...
        <div className="absolute left-[14px] overflow-clip size-[28px] top-[14px]" data-name="ungroup">
          <div className="absolute inset-[16.67%_45.83%_58.33%_20.83%]" data-name="Vector">
            <div className="absolute inset-[-7.14%_-5.36%]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10.3333 8">
                <path d={svgPaths.p811b700} id="Vector" stroke="var(--stroke-0, #353E49)" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </div>
          </div>
          <div className="absolute inset-[58.33%_20.83%_16.67%_45.83%]" data-name="Vector">
...
function Section1() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[50px]" data-name="Section">
      <p className="font-['Nunito_Sans:Regular',sans-serif] font-light leading-[18px] relative shrink-0 text-[#414141] text-[12px] w-full" style={{ fontVariationSettings: "'YTLC' 500, 'wdth' 100" }}>{`Masonry `}</p>
    </div>
  );
}
...
function FeaturedIcon() {
  return (
    <div className="bg-white content-stretch flex items-center justify-center relative rounded-[8px] self-stretch shadow-[0px_1px_2px_0px_rgba(16,24,40,0.05)] shrink-0" data-name="Featured icon">
      <div className="overflow-clip relative shrink-0 size-[28px]" data-name="chevron-right">
        <div className="absolute bottom-1/4 left-[37.5%] right-[37.5%] top-1/4" data-name="Vector">
          <div className="absolute inset-[-3.57%_-7.14%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 8 15">
              <path d="M0.5 14.5L7.5 7.5L0.5 0.5" id="Vector" stroke="var(--stroke-0, #353E49)" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </div>
        </div>
      </div>
...
function Section2() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Section">
      <p className="font-['Nunito_Sans:Regular',sans-serif] font-light leading-[18px] relative shrink-0 text-[#414141] text-[12px] whitespace-nowrap" style={{ fontVariationSettings: "'YTLC' 500, 'wdth' 100" }}>{`Data Structures & Algorithms`}</p>
    </div>
  );
}
...
function Selected() {
  return (
    <div className="content-stretch flex gap-[12px] items-start relative shrink-0 w-full" data-name="Selected">
      <div className="content-stretch flex gap-[10px] items-start p-[12px] relative rounded-[8px] shrink-0" data-name="List Item">
        <div aria-hidden="true" className="absolute border border-[#0a77ff] border-solid inset-0 pointer-events-none rounded-[8px]" />
        <div className="overflow-clip relative shrink-0 size-[16px]" data-name="ungroup">
          <div className="absolute inset-[16.67%_45.83%_58.33%_20.83%]" data-name="Vector">
            <div className="absolute inset-[-12.5%_-9.37%]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 6.33333 5">
                <path d={svgPaths.p633ba40} id="Vector" stroke="var(--stroke-0, #0088FF)" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </div>
          </div>
          <div className="absolute inset-[58.33%_20.83%_16.67%_45.83%]" data-name="Vector">
        ...
        <Section1 />
        <div className="content-stretch flex items-center justify-center relative rounded-[200px] shrink-0" data-name="Checkbox">
          <div className="bg-[#34c759] overflow-clip relative rounded-[1000px] shrink-0 size-[16px]" data-name="_Checkbox base">
      ...
      <div className="content-stretch flex gap-[10px] items-start p-[12px] relative rounded-[8px] shrink-0" data-name="List Item">
        <div aria-hidden="true" className="absolute border border-[#0a77ff] border-solid inset-0 pointer-events-none rounded-[8px]" />
        <div className="overflow-clip relative shrink-0 size-[16px]" data-name="boxes">
          <div className="absolute bottom-[9.73%] left-[8.33%] right-1/2 top-[43.75%]" data-name="Vector">
            <div className="absolute inset-[-6.72%_-7.5%]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 7.66667 8.44375">
                <path d={svgPaths.p37e7be00} id="Vector" stroke="var(--stroke-0, #0088FF)" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </div>
          </div>
          <div className="absolute inset-[56.87%_70.83%_31.25%_9.42%]" data-name="Vector">
            <div className="absolute inset-[-26.32%_-15.83%]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 4.16015 2.90015">
                <path d={svgPaths.p281754c0} id="Vector" stroke="var(--stroke-0, #0088FF)" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </div>
          </div>
          <div className="absolute bottom-[31.25%] left-[29.17%] right-1/2 top-[56.25%]" data-name="Vector">
            <div className="absolute inset-[-25%_-15%]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 4.33348 3.00015">
                <path d={svgPaths.p208caa00} id="Vector" stroke="var(--stroke-0, #0088FF)" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </div>
          </div>
          <div className="absolute inset-[68.75%_70.83%_9.71%_29.17%]" data-name="Vector">
            <div className="absolute inset-[-14.51%_-0.5px]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1 4.44667">
                <path d="M0.5 0.5V3.94667" id="Vector" stroke="var(--stroke-0, #0088FF)" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </div>
          </div>
          <div className="absolute bottom-[9.73%] left-1/2 right-[8.33%] top-[43.75%]" data-name="Vector">
            <div className="absolute inset-[-6.72%_-7.5%]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 7.66667 8.44375">
                <path d={svgPaths.pcb88a00} id="Vector" stroke="var(--stroke-0, #0088FF)" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </div>
          </div>
          <div className="absolute bottom-[31.25%] left-1/2 right-[29.17%] top-[56.25%]" data-name="Vector">
            <div className="absolute inset-[-25%_-15%]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 4.33348 3.00015">
                <path d={svgPaths.p379d8} id="Vector" stroke="var(--stroke-0, #0088FF)" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </div>
          </div>
          <div className="absolute inset-[56.87%_9.42%_31.25%_70.83%]" data-name="Vector">
            <div className="absolute inset-[-26.32%_-15.83%]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 4.16015 2.90015">
                <path d={svgPaths.p8330240} id="Vector" stroke="var(--stroke-0, #0088FF)" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </div>
          </div>
          ...
          <div className="absolute inset-[9.73%_29.17%_43.75%_29.17%]" data-name="Vector">
            <div className="absolute inset-[-6.72%_-7.5%]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 7.66667 8.44375">
                <path d={svgPaths.p3b3f9600} id="Vector" stroke="var(--stroke-0, #0088FF)" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </div>
          </div>
          ...
          <div className="absolute bottom-[43.75%] left-1/2 right-1/2 top-[33.33%]" data-name="Vector">
            <div className="absolute inset-[-13.64%_-0.5px]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1 4.66667">
                <path d="M0.5 4.16667V0.5" id="Vector" stroke="var(--stroke-0, #0088FF)" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </div>
          </div>
        </div>
...
function TextPadding2() {
  return (
    <div className="content-stretch flex items-center justify-center px-[2px] relative shrink-0" data-name="Text padding">
      <p className="font-['Nunito_Sans:Medium',sans-serif] font-medium leading-[20px] relative shrink-0 text-[14px] text-white whitespace-nowrap" style={{ fontVariationSettings: "'YTLC' 500, 'wdth' 100" }}>{`Next `}</p>
    </div>
  );
}
...
function Content14() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start relative rounded-[12px] shrink-0 w-full" data-name="Content">
      <Selected />
      <Actions2 />
    </div>
  );
...
function Content13() {
  return (
    <div className="content-stretch flex flex-col gap-[32px] items-center relative shrink-0 w-[480px]" data-name="Content">
      <Header1 />
      <Content14 />
    </div>
  );
...
function Form() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-full" data-name="Form">
      <p className="font-['Nunito_Sans:Regular',sans-serif] font-normal leading-[24px] min-w-full relative shrink-0 text-[#101828] text-[16px] w-[min-content]" style={{ fontVariationSettings: "'YTLC' 500, 'wdth' 100" }}>
        Add Comment (Optional)
      </p>
      <button className="content-stretch cursor-pointer flex flex-col gap-[6px] h-[157px] items-start relative shrink-0 w-full" data-name="Textarea input field">
        <InputWithLabel />
...
export default function TradeCompetency() {
  return (
    <div className="bg-white relative size-full" data-name="TRADE & COMPETENCY">
      <Frame6 />
      <SidebarNavigation />
    </div>
  );
