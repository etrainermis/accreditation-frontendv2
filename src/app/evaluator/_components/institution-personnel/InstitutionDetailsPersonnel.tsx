...
import _imgAvatar1 from '../assets/avatar-2.png';
...
function TextAndSupportingText7() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-h-px min-w-px relative whitespace-nowrap" data-name="Text and supporting text">
      <p className="font-['Nunito_Sans:Medium',sans-serif] font-medium leading-[20px] min-w-full overflow-hidden relative shrink-0 text-[#101828] text-[14px] text-ellipsis w-[min-content]" style={{ fontVariationSettings: "'YTLC' 500, 'wdth' 100" }}>
        Drew Cano
      </p>
...
function Column() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-h-px min-w-px relative" data-name="Column">
        ...
        <div className="flex flex-row items-center size-full">
          <div className="content-stretch flex gap-[12px] items-center px-[24px] py-[16px] relative size-full">
            ...
            <div className="relative rounded-[9999px] shrink-0 size-[40px]" data-name="Avatar">
              ...
              <ContrastBorder1 />
              <div className="absolute inset-[20%] overflow-clip" data-name="user-01">
                <div className="absolute inset-[12.5%_16.67%]" data-name="Icon">
                  <div className="absolute inset-[-5.56%_-6.25%]">
                    <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18.0002 20">
                      <path d={svgPaths.p1f907700} id="Icon" stroke="var(--stroke-0, #667085)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
                    </svg>
                  </div>
                </div>
              </div>
      ...
      <div className="bg-[#fefeff] h-[72px] relative shrink-0 w-full" data-name="Table cell">
        <div aria-hidden="true" className="absolute border-[#eaecf0] border-b border-solid inset-0 pointer-events-none" />
        <div className="flex flex-row items-center size-full">
          <div className="content-stretch flex gap-[12px] items-center px-[24px] py-[16px] relative size-full">
            <div className="content-stretch flex items-center justify-center relative shrink-0" data-name="Checkbox">
...
function TextAndSupportingText11() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col font-['Nunito_Sans:Regular',sans-serif] font-light h-full items-start leading-[18px] min-h-px min-w-px relative text-[12px] whitespace-nowrap" data-name="Text and supporting text">
      <p className="overflow-hidden relative shrink-0 text-[#101828] text-ellipsis w-full" style={{ fontVariationSettings: "'YTLC' 500, 'wdth' 100" }}>
        Deputy Director
      </p>
      <p className="overflow-hidden relative shrink-0 text-[#84888c] text-ellipsis w-full" style={{ fontVariationSettings: "'YTLC' 500, 'wdth' 100" }}>
        Qualification
      </p>
    </div>
  );
...
function Column1() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[151px]" data-name="Column">
...
function TextAndSupportingText16() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col font-['Nunito_Sans:Regular',sans-serif] font-light h-full items-start leading-[18px] min-h-px min-w-px relative whitespace-nowrap" data-name="Text and supporting text">
      <p className="overflow-hidden relative shrink-0 text-[#101828] text-[12px] text-ellipsis w-full" style={{ fontVariationSettings: "'YTLC' 500, 'wdth' 100" }}>
        natali@gmail.com
      </p>
      <p className="overflow-hidden relative shrink-0 text-[#475467] text-[10px] text-ellipsis w-full" style={{ fontVariationSettings: "'YTLC' 500, 'wdth' 100" }}>
        +250-79-123-456-789
      </p>
    </div>
  );
...
export default function InstitutionDetailsPersonnel() {
  return (
    <div className="bg-white relative size-full" data-name="INSTITUTION_DETAILS [PERSONNEL]">
      <Frame6 />
      <SidebarNavigation />
    </div>
  );
